...
import { Component, type OnInit, OnDestroy, signal, computed } from '@angular/core';
...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  private updateClock() {
    ...
    this.currentDate.set(now.toLocaleDateString([], { weekday: 'long', month: 'long', day: 'numeric', year: 'numeric' }));
  }
}
