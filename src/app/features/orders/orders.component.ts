...
@Component({
  ...
  template: `
    <div class="p-3 sm:p-5 max-w-7xl mx-auto">
      ...
      <!-- Content Area: Defer loading actual table -->
                    ...
                    >
                      ...
                      <td class="px-6 py-4">
                        <div class="flex flex-col">
                          @if (
                            dataService.getCustomerIdByName(order.customer);
                            as custId
                          ) {
                            <a
                ...
                <div class="flex flex-wrap items-center gap-4">
                  ...
                  <div class="flex items-center gap-3">
                    ...
                    <span
                      ...
                      >Matches</span
                    >
                    @if (searchQuery() || selectedStatus() !== "All Statuses") {
                      <span
          ...
          >
            ...
            >
              @for (i of [1, 2, 3, 4, 5]; track i) {
                <lib-skeleton width="100px" height="1rem"></lib-skeleton>
              }
            </div>
